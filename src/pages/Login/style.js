...
export const AuthContent = w.div('m-auto w-full max-w-md py-10 px-6 flex flex-col gap-5 rounded-md bg-gray-900')
...
export const RememberForgot = w.div('w-full flex justify-between items-center')

export const RememberMe = w.div('w-fit flex justify-start items-center gap-3')

export const CreateAccount = w.div('w-full flex justify-center items-center')
