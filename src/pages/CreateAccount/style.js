...
export const PassStrength = w.div(
	'w-full flex flex-row justify-center items-center gap-1'
)
export const Progress = w.div(
	'w-full h-1 rounded-sm bg-green-600'
)

export const PrivacyTerms = w.div(
	'flex flex-row justify-start items-center gap-1'
)

export const AlreadyHave = w.div(
